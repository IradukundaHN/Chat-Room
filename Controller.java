...
public class Controller extends Application {
	...
	public void start(Stage stage)
	{
		...
		step1Label = new Label("1. Start the server.");
		step2Label = new Label("2. Start a client.");
		step3Label = new Label("3. Enter a screen name in the clients's GUI.");
		step4Label = new Label("4. Start more clients.");
		...
		instructionTitlePane.getChildren().addAll(titleLabel);
		...
		instructionPane.getChildren().addAll(instructionTitlePane, step1Label, step2Label, step3Label, step4Label, step5InstructionLabel);
